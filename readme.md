...
python srm_module_collect.py . -o srm_project.json
python srm_project_verify.py srm_project.json
python srm_project_merge.py srm_project.json -o srm_resolved.json
python srm_layout_verify.py --resolved srm_resolved.json --types srm_types.json
python srm_layout_generate.py --resolved srm_resolved.json --types srm_types.json --output ./build/srm/srm_layout
```
