...
class TestF4ReferenceIntegrity:
    ...
    def test_f4_01_valid_reference(self):
        """TC-F4-01: 正常跨模块引用"""
        project_dir = get_testcase_project("PYTHON-TC-F4-01")
    ...
    def test_f4_02_empty_storages_list(self):
        ...
        project_dir = get_testcase_project("PYTHON-TC-F4-02")
    ...
    def test_f4_03_undefined_storage(self):
        ...
        project_dir = get_testcase_project("PYTHON-TC-F4-03")
    ...
    def test_f4_04_duplicate_external_alias(self):
        ...
        project_dir = get_testcase_project("PYTHON-TC-F4-04")
    ...
    def test_f4_05_alias_not_in_target(self):
        ...
        project_dir = get_testcase_project("PYTHON-TC-F4-05")
    ...
    def test_f4_06_alias_conflicts_with_local(self):
        ...
        project_dir = get_testcase_project("PYTHON-TC-F4-06")
    ...
    def test_f4_07_source_module_not_found(self):
        ...
        project_dir = get_testcase_project("PYTHON-TC-F4-07")
