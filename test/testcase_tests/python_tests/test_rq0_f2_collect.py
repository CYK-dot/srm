...
class TestF2ModuleCollection:
    ...
    def test_f2_01_no_module_files(self):
        """TC-F2-01: 无模块文件，警告退出"""
        project_dir = get_testcase_project("RQ0_PYTHON_F2_01")
    ...
    def test_f2_02_single_valid_module(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F2_02")
    ...
    def test_f2_03_module_missing_name(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F2_03")
    ...
    def test_f2_04_multiple_valid_modules(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F2_04")
    ...
    def test_f2_05_one_module_missing_name(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F2_05")
    ...
    def test_f2_06_duplicate_module_names(self):
        """TC-F2-06: 多模块同名，报错退出"""
        project_dir = get_testcase_project("RQ0_PYTHON_F2_06")
