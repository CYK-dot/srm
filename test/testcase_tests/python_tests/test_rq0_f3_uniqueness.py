...
class TestF3GlobalUniqueness:
    ...
    def test_f3_01_all_unique(self):
        """TC-F3-01: 全局唯一性通过"""
        project_dir = get_testcase_project("RQ0_PYTHON_F3_01")
    ...
    def test_f3_02_duplicate_item_names(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F3_02")
    ...
    def test_f3_03_duplicate_storage_names(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F3_03")
    ...
    def test_f3_04_both_duplicates(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F3_04")
