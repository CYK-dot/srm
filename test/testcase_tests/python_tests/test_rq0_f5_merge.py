...
class TestF5ProjectMerge:
    ...
    def test_f5_01_single_module(self):
        """TC-F5-01: 单模块合并"""
        project_dir = get_testcase_project("RQ0_PYTHON_F5_01")
    ...
    def test_f5_02_storage_only_no_items(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F5_02")
    ...
    def test_f5_03_multiple_modules(self):
        """TC-F5-03: 多模块合并"""
        project_dir = get_testcase_project("RQ0_PYTHON_F5_03")
    ...
    def test_f5_04_invalid_storage_reference(self):
        ...
        project_dir = get_testcase_project("RQ0_PYTHON_F5_04")
